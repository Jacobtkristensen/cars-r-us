...
//        ResponseStatusException ex = assertThrows(ResponseStatusException.class, () -> memberService.findById("user3"));
...
//        //This should test that a ResponseStatus exception is thrown with status= 404 (NOT_FOUND)
//        MemberRequest m3 = new MemberRequest(m1);
//        assertThrows(ResponseStatusException.class, () -> memberService.editMember(m3, "user3"));
//    }
//
//    @Test
